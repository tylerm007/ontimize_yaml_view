...
class Config:
    ...
    if is_docker and CREATED_FLASK_HOST == "localhost":
        ...
        #CREATED_SWAGGER_HOST="127.0.0.1"
    CREATED_PORT = "5655"
    ...
    # Database
    SQLALCHEMY_DATABASE_URI : typing.Optional[str] = f"postgresql://postgres:p@127.0.0.1/yaml"
    ...
    SQLALCHEMY_DATABASE_URI_AUTHENTICATION = 'postgresql://postgres:p@127.0.0.1/authdb'
