...
docker run --env-file devops/docker-image/env.list -it --name api_logic_project --rm --net dev-network -p 5655:5655 -p 5002:5002 -p 4298:4298 apilogicserver/ontimize_yaml_editor
