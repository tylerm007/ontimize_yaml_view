...
app_logger.info(f'Created July 19, 2024 16:35:14 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.04.95\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.04.95\n'
    msg += f'.. startup message: {start_up_message}\n'
