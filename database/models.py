...
#
# Created:  July 14, 2024 09:44:34
# Database: postgresql://postgres:p@127.0.0.1/yaml
# Dialect:  postgresql
#
# mypy: ignore-errors
########################################################################################################################
...
class Entity(SAFRSBaseX, Base):
    ...
    TabGroupList : Mapped[List["TabGroup"]] = relationship(foreign_keys='[TabGroup.entity_name]')
    TabGroupList1 : Mapped[List["TabGroup"]] = relationship(foreign_keys='[TabGroup.tab_entity]')
...
class YamlFiles(SAFRSBaseX, Base):
    ...
    directory = Column(Boolean, server_default=text("false"), nullable=False)
