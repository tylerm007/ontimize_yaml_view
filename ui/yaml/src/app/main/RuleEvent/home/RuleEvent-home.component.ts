...
@Component({
  selector: 'RuleEvent-home',
  templateUrl: './RuleEvent-home.component.html',
  styleUrls: ['./RuleEvent-home.component.scss']
})
export class RuleEventHomeComponent implements AfterViewInit {
