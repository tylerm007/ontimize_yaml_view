...
@Component({
  selector: 'MenuGroup-home',
  templateUrl: './MenuGroup-home.component.html',
  styleUrls: ['./MenuGroup-home.component.scss']
})
export class MenuGroupHomeComponent implements AfterViewInit {
