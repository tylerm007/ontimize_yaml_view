...
@Component({
  selector: 'RuleConstraint-home',
  templateUrl: './RuleConstraint-home.component.html',
  styleUrls: ['./RuleConstraint-home.component.scss']
})
export class RuleConstraintHomeComponent implements AfterViewInit {
