...
@Component({
  selector: 'PageProperty-home',
  templateUrl: './PageProperty-home.component.html',
  styleUrls: ['./PageProperty-home.component.scss']
})
export class PagePropertyHomeComponent implements AfterViewInit {
