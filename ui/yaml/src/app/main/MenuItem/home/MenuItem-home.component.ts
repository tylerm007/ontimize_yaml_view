...
@Component({
  selector: 'MenuItem-home',
  templateUrl: './MenuItem-home.component.html',
  styleUrls: ['./MenuItem-home.component.scss']
})
export class MenuItemHomeComponent implements AfterViewInit {
