...
@Component({
  selector: 'ApplicationEntity-home',
  templateUrl: './ApplicationEntity-home.component.html',
  styleUrls: ['./ApplicationEntity-home.component.scss']
})
export class ApplicationEntityHomeComponent implements AfterViewInit {
