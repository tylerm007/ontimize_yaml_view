...
@Component({
  selector: 'GrantRole-home',
  templateUrl: './GrantRole-home.component.html',
  styleUrls: ['./GrantRole-home.component.scss']
})
export class GrantRoleHomeComponent implements AfterViewInit {
