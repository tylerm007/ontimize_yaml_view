...
@Component({
  selector: 'RuleDerivation-home',
  templateUrl: './RuleDerivation-home.component.html',
  styleUrls: ['./RuleDerivation-home.component.scss']
})
export class RuleDerivationHomeComponent implements AfterViewInit {
